...
Create detailed Product Requirements Documents that are clear, actionable, and suitable for autonomous implementation by Droid Ralph.
...
**Each story must be completable in ONE Droid iteration (one context window).**

If a story is too big, the LLM runs out of context before finishing and produces poor code.
